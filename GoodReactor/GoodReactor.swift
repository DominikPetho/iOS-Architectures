    ...
    func createStateStream() -> AnyPublisher<State, Never> {
        ...
        let transformedState = self.transform(state: state)
            .handleEvents(receiveOutput: { [weak self] state in
                debugPrint("Reactor", "State changed")
...
//    "Reactor" "Transformed"
//    "Reactor" "Navigate"
//    task: receive subscription: (Concatenate)
//    task: request unlimited
//    task: receive value: (delete)
//    "Reactor" "Mutated"
